...
export default class TransactionScreen extends React.Component {
  ...
  getCameraPermissions = async () => {
    ...
    //status === "granted" is false when the user has not granted the permission,
  ...
  handleTransaction = async () => {
    ...
    if (!transactionType) {
      alert("Book Does not exist in the libraries database");
      this.setState({
        scannedStudentId: "",
        scannedBookId: "",
      });
